...
namespace ISL.TPP.Core.Tests.Unit.Services.Foundations.Files
{
    public partial class FileServiceTests
    {
        ...
        [InlineData("")]
        [InlineData("   ")]
        public async Task ShouldThrowValidationExceptionOnCopyFileIfPathsIsInvalidAsync(string invalidPath)
        {
            // given
            ...
            ValueTask<bool> moveFileTask =
                this.fileService.CopyFileAsync(invalidSourcePath, invalidDestinationPath);
            ...
            this.fileBrokerMock.Verify(broker =>
                broker.CopyFileAsync(invalidSourcePath, invalidDestinationPath),
                    Times.Never);
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnCopyFileIfSourceFileDoesNotExistsAsync()
        {
            // given
            ...
            // when
            ValueTask<bool> moveFileTask =
                this.fileService.CopyFileAsync(fullSourcePath, fullDestinationPath);
