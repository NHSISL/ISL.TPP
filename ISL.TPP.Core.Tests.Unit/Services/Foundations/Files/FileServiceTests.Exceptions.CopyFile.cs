...
namespace ISL.TPP.Core.Tests.Unit.Services.Foundations.Files
{
    public partial class FileServiceTests
    {
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnCopyFileIfDependencyValidationErrorOccursAsync(
            Exception dependencyValidationException)
        {
            ...
            ValueTask<bool> moveFileTask =
                this.fileService.CopyFileAsync(someSourcePath, someDestinationPath);
        ...
        public async Task ShouldThrowDependencyExceptionOnCopyFileIfDependencyErrorOccursAsync(
        ...
        [Fact]
        public async Task ShoudThrowServiceExceptionOnCopyFileIfServiceErrorOccursAsync()
        {
            // given
            string someSourcePath = GetRandomString();
            string someDestinationPath = GetRandomString();
            ...
            // when
            ValueTask<bool> moveFileTask = this.fileService.CopyFileAsync(someSourcePath, someDestinationPath);
